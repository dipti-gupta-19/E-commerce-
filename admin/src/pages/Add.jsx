...
import { backendUrl as backendURL } from "../App";
  ...
  return (
    <form onSubmit={onSubmitHandler} className  ="flex flex-col w-full items-start gap-3" action="">
      ...
      <div className="w-full">
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className="w-full max-w-[500px] px-3 py-2" type="text" placeholder="Write your content here" ></textarea>
      </div>
